...
Topic: Segment Tree
Difficulty: Hard
Approach: Maintain obstacle positions in a set and store maximum gap lengths using a segment tree. For each query, determine the largest available segment before x.
Time: O(q log N)
Space: O(N)
*/
